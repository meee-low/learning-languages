...
compile_and_run() {
  ...
  compilation_flags="-Werror -new-syntax -deprecation -d $build_folder -classpath $build_folder -explain -unchecked"

  # Compile the Scala file
  echo scalac "$compilation_flags $1"
  echo "Compiling..."
  scalac $compilation_flags $1
